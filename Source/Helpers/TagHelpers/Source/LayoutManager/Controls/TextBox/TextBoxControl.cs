...
namespace RazorTechnologies.TagHelpers.LayoutManager.Controls.TextBox
{
    public class TextBoxControl : BaseInputControl<TextBoxControlVMAttribute>
    {
        ...
        public override IHtmlTagContent GetHtmlTagContent(IValueModel valueModel)
        {
            ...
            sb.AppendFormat("<input type='text' id='{0}' name='{1}' value='{2}' placeholder='...' {4} class='form-control' style='' {3}/>", Options.HtmlTag.UniqueId, Options.HtmlTag.Name, valueModel.Content, RenderHtmlElementDisabledAttribute(!Options.ForceDisabled), RenderHtmlElementAttribute(Options.HtmlTag.Form, Options.HtmlTag.Form));
